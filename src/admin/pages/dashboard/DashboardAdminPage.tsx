import ActivityFeed from "@/admin/components/ActvityFeed";
...
export function DashboardAdminPage(){
    return(
        <>
             <AdminTitle title="Panel de Administrador" 
             description="Bienvenido al panel de administracion de testo shop"/>
